      ...
      <div className=" grid md:grid-cols-2 relative gap-5 px-3">
        ...
        <div className=" hidden md:grid grid-cols-2 h-full gap-5">
          ...
          {remainingPhotosCount > 0 && (
            <div
              className=" cursor-pointer relative h-64 rounded-xl overflow-hidden"
            ...
            >
              <Image
                ...
                className="img"
              />
              <div className=" absolute cursor-pointer text-white inset-0 flex justify-center bg-[rgb(0,0,0,0.5)] items-center text-2xl">
